...
# создаём спрайты
ship = Player(img_hero, 7, win_height - 100, 80, 100, 10)
...
for i in range(1, 32):
    asteroid = Meteor(img_asteroid, randint(80, win_width - 80), -40, 80, 50, randint(1, 9))
...
while run:
    ...
    if not finish:
        ...
        if sprite.spritecollide(ship, monsters, False, False) or lost >= max_lost or sprite.spritecollide(ship, asteroids, False, False):
            finish = True  # проиграли, ставим фон и больше не управляем спрайтами.
            window.blit(lose, (370, 400))
    ...
    # бонус: автоматический перезапуск игры
        ...
        for i in range(1, 6):
            ...
            monsters.add(monster)
        for i in range(1, 32):
            asteroid = Meteor(img_asteroid, randint(80, win_width - 80), -40, 80, 50, randint(1, 5))
            asteroids.add(asteroid)
